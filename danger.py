...
TOKEN = '7247492844:AAHQ9Er_BUcuK94DcNBTADqZ29iQhigDDbI'
...
FORWARD_CHANNEL_ID = -1002330521197
CHANNEL_ID = -1002330521197
error_channel_id = -1002330521197
...
def handle_message(message):
    if message.text == "":
        ...
        bot.send_message(message.chat.id, "*Dm - @IRFAN_HACK*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*Owner - @IRFAN_HACK*", parse_mode='Markdown')
    else:
